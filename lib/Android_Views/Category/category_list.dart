  ...
  _connectionCheck(index, i) async {
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (BuildContext context) =>
                CourseEnroll(course: _categoryList[index].courses[i]),
          ),
        );
      ...
      showAlertDialog(
          ...
          'Please connect to your wifi or turn on mobile data and try again',
          index,
          i,
          context);
    }
    ...
    return GestureDetector(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[_loading?Container():Padding(
            ...
            highlightColor: Colors.transparent,
              ...
              onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context)=> Search(courselist: _searchList,)
                ));
              },
            ))],
